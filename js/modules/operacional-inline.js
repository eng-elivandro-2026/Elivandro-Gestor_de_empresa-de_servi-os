...
(function (window, document) {
  ...
  function renderGestaoNegocio(el, o) {
    ...
    el.innerHTML = ajusteResponsivoHtml()
      ...
      + '@page{size:A4;margin:10mm;@bottom-right{content:"Página " counter(page) " de " counter(pages);font-size:8pt;color:#64748b;font-family:inherit;}}'
      ...
      + '.op-doc-print-section{margin:.6rem 0!important;}'
      + '.op-report-hours-section{margin:.6rem 0!important;}'
      + '.op-signatures-section{margin-top:8mm!important;}'
      ...
      + '.op-report-hours-section th,.op-report-hours-section td{padding:.3rem .35rem!important;}'
      + 'h3.op-doc-section-title{margin:.5rem 0 .35rem!important;font-size:.78rem!important;}'
      + '#opGestaoDiario{min-height:auto!important;height:auto!important;border:1px solid #94a3b8!important;border-radius:0!important;resize:none!important;overflow:visible!important;background:#fff!important;font-size:9pt!important;line-height:1.4!important;}'
