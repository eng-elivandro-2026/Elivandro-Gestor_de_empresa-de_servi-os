...
(function (window, document) {
  ...
  function renderGestaoNegocio(el, o) {
    ...
    el.innerHTML = ajusteResponsivoHtml()
      ...
      + '@page{size:A4;margin:15mm 15mm;@bottom-right{content:"Página " counter(page) " de " counter(pages);font-size:8pt;color:#64748b;font-family:inherit;}}'
      ...
      + '#opGestaoPrintRoot .op-print-paper{display:block!important;max-width:210mm!important;width:100%!important;margin:0 auto!important;padding:15mm!important;border:0!important;box-shadow:none!important;border-radius:0!important;background:#fff!important;box-sizing:border-box!important;}'
      ...
      + '.op-doc-print-section{margin:.8rem 0!important;page-break-inside:avoid;}'
      + '.op-report-hours-section{page-break-inside:avoid;}'
      + '.op-signatures-section,.op-signature-card{break-inside:avoid;page-break-inside:avoid;}'
      ...
      + '.op-report-hours-section table{width:100%!important;min-width:0!important;font-size:9pt!important;border-collapse:collapse!important;}'
      + '.op-report-hours-section th,.op-report-hours-section td{padding:.35rem .4rem!important;border:1px solid #e2e8f0!important;}'
      + '#opGestaoDiario{min-height:auto!important;height:auto!important;border:1px solid #94a3b8!important;border-radius:0!important;resize:none!important;overflow:visible!important;background:#fff!important;font-size:11pt!important;line-height:1.4!important;}'
      + '.op-signatures-section{margin-top:1.2rem!important;page-break-before:avoid;}'
      + '.op-signature-card{border-color:#94a3b8!important;page-break-inside:avoid;}'
