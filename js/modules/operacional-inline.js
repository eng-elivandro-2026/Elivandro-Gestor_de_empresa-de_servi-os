...
(function (window, document) {
  ...
  function renderGestaoNegocio(el, o) {
    ...
    el.innerHTML = ajusteResponsivoHtml()
      ...
      + '.op-report-hours-section table{width:100%!important;min-width:0!important;font-size:9pt!important;}'
      + '.op-report-hours-section th,.op-report-hours-section td{padding:.35rem .4rem!important;}'
      + 'h3.op-doc-section-title{margin:.6rem 0 .4rem!important;font-size:.82rem!important;}'
      + '#opGestaoDiario{min-height:auto!important;height:auto!important;border:1px solid #94a3b8!important;border-radius:0!important;resize:none!important;overflow:visible!important;background:#fff!important;font-size:10pt!important;line-height:1.45!important;}'
      + '.op-signatures-section{margin-top:10mm!important;}'
      + '.op-signature-card{border-color:#94a3b8!important;}'
      + '.op-doc-print-section{margin:.8rem 0!important;}'
