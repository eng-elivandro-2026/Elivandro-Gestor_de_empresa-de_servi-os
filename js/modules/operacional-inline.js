...
(function (window, document) {
  ...
  function renderGestaoNegocio(el, o) {
    ...
    el.innerHTML = ajusteResponsivoHtml()
      ...
      + '@page{size:A4;margin:8mm 10mm;@bottom-right{content:"Página " counter(page) " de " counter(pages);font-size:8pt;color:#64748b;font-family:inherit;}}'
      ...
      + '.op-doc-print-section,.op-report-hours-section,.op-signatures-section{margin:.5rem 0!important;page-break-inside:avoid!important;}'
      + '.op-signature-card{break-inside:avoid!important;page-break-inside:avoid!important;}'
      ...
      + '.op-report-hours-section table{width:100%!important;min-width:0!important;font-size:8pt!important;}'
      + '.op-report-hours-section th,.op-report-hours-section td{padding:.2rem .25rem!important;font-size:7.5pt!important;}'
      + 'h3.op-doc-section-title{margin:.4rem 0 .3rem!important;font-size:.75rem!important;}'
      + '#opGestaoDiario{min-height:auto!important;max-height:200px!important;height:auto!important;border:1px solid #94a3b8!important;border-radius:0!important;resize:none!important;overflow:auto!important;background:#fff!important;font-size:9pt!important;}'
      + '.op-signatures-section{margin-top:5mm!important;}'
