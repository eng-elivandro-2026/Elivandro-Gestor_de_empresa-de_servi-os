  ...
  var MODULOS = [
    {
      ...
      nav: [
        { separator: true, label: 'Identidade' },
        ...
        { label: 'Identidade da Empresa', icon: '🪪', action: "Router.ir('dashboard-minha-empresa');Router.iframeMsg('dashboard-minha-empresa','SHOW_SECTION','identidade')" },
        { label: 'Vantagem Competitiva', icon: '🏆', emBreve: true },
        { separator: true, label: 'Estrutura' },
        { label: 'Cadeia de Valor', icon: '🔗', emBreve: true },
        { label: 'Macro-processos', icon: '🗺️', emBreve: true },
    ...
    },
    {
      ...
      nav: [
        ...
        { label: 'SWOT', icon: '📊', emBreve: true },
        { label: 'OKR', icon: '🎯', emBreve: true },
        { label: 'BSC', icon: '📈', emBreve: true },
        { label: 'Plano de 90 dias', icon: '📅', emBreve: true },
        { separator: true, label: 'Priorização' },
        { label: 'Matriz GUT', icon: '⚖️', emBreve: true },
        { label: 'Now / Next / Later', icon: '🔜', emBreve: true },
        { separator: true, label: 'Riscos' },
        { label: 'Mapa de Riscos', icon: '⚠️', emBreve: true },
      ]
    },
    {
      id: 'rh',
    ...
    },
    {
      ...
      // Espelha renderMenuComercialOrganizado() (index.html) — fonte real do
      // submenu Comercial. Este nav é só fallback (usado se aquela função não
      // rodar); mantido em sincronia: 3 grupos, mesmos itens/ordem/subs.
      nav: [
        ...
        { separator: true, label: 'Visão Comercial' },
        { label: 'Visão Geral',                  icon: '📊', action: "irParaPainel('visaoGeralCard','togVisaoGeral')" },
        { label: 'Visão Executiva',              icon: '🏢', sub: 'visao_executiva', action: "irParaPainel('ceoDashCard','togCeoDash')" },
        { label: 'KPIs de Ciclos — Média Geral', icon: '📊', action: "irParaPainel('ciclosCard','togCiclosDash')" },
        { label: 'Linha do Tempo de Execução',   icon: '📅', action: "irParaPainel('execTimelineCard','togExecTimeline')" },
        { label: 'Metas2026',                    icon: '🎯', sub: 'metas',           action: "irParaPainel('metaPanel','togMeta')" },
        { label: 'Fechamentos por Mês',          icon: '📅', action: "irParaPainel('fechMesCard','togFechMes')" },
        { label: 'Por Fase',                     icon: '📈', action: "irParaPainel('porFaseCard','togPorFase')" },
        { label: 'Ranking de Clientes',          icon: '🏢', sub: 'ranking_clientes', action: "irParaPainel('rankingCard','togRanking')" },
        { separator: true, label: 'Ferramentas' },
        ...
        { label: 'Análise por Categoria',        icon: '📂', action: "irParaPainel('catAnaliseCard','togCatAnalise')" },
        { label: 'Análise de Proposta',          icon: '📈', action: "go('analise',this);rAnalise()" },
    ...
    },
    {
      ...
      nav: [
        ...
        { separator: true, label: 'Abertura' },
        { label: 'Passagem de Bastão', icon: '🤝', emBreve: true },
        { label: 'Boas-vindas ao Cliente', icon: '📧', emBreve: true },
        { separator: true, label: 'Entrega' },
        { label: 'Checklist Técnico', icon: '✅', emBreve: true },
        { label: 'Checklist Documental', icon: '📄', emBreve: true },
        { label: 'Termo de Aceite', icon: '✍️', emBreve: true },
        { label: 'AAR — After Action Review', icon: '🎖️', emBreve: true },
        { separator: true, label: 'Pós-venda' },
        { label: 'Agenda D+7 / D+30 / D+90', icon: '📞', emBreve: true },
        { label: 'Registro de Contato', icon: '📝', emBreve: true },
        { label: 'Nova Oportunidade', icon: '🔁', emBreve: true },
      ]
    },
    {
      id: 'engenharia',
    ...
    },
    {
      ...
      nav: [
        { separator: true, label: 'Faturamento' },
        { label: 'NFs de Faturamento',  icon: '📄', action: "Router.iframeMsg('financeiro','SHOW_TAB','nfs');Router._setNavAtivo(this)" },
        { label: 'NFs de Fornecedores', icon: '📥', action: "Router.iframeMsg('financeiro','SHOW_TAB','nf-fornecedor');Router._setNavAtivo(this)" },
        { separator: true, label: 'Contas' },
        ...
        { separator: true, label: 'Visão Financeira' },
        ...
        { label: 'Margem de Contribuição', icon: '📈', emBreve: true },
        { label: 'EBITDA', icon: '📉', emBreve: true },
        { label: 'Ciclos Financeiros', icon: '🔄', emBreve: true },
        { separator: true, label: 'Ferramentas' },
    ...
    },
    {
      ...
      nav: [
        { separator: true, label: 'Rituais' },
        { label: 'Reunião Diária', icon: '📅', emBreve: true },
        { label: 'Reunião de Radar', icon: '🗓️', action: "Router.ir('reuniao-radar')" },
        { label: 'Reunião Mensal', icon: '📆', emBreve: true },
        { label: 'Reunião Trimestral', icon: '📊', emBreve: true },
        { label: 'Planejamento Anual', icon: '🎯', emBreve: true },
        { separator: true, label: 'Planos de Ação' },
        { label: '5W2H', icon: '📋', emBreve: true },
        { label: 'PDCA', icon: '🔄', emBreve: true },
        { label: 'Tarefas', icon: '✅', emBreve: true },
        { separator: true, label: 'Aprendizado' },
        { label: 'Lições Aprendidas', icon: '📚', emBreve: true },
      ]
    },
    {
